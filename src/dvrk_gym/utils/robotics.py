...
"""
Helper functions for robotics-related calculation, primarily for converting
between different rotation representations (Euler, Quaternion, Matrix).
Based on the SurRoL implementation.
"""
import numpy as np
